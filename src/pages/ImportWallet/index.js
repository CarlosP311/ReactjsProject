    ...
    return (
        <div>
            <div className = "password__container">
                <h2 className="h2__title">Create New Password</h2>
                <br /><br />
                <form className = "form__container">   
                    <div className = "password__group">      
                        <input className = "password__input" type = "password" value = {props.password} onChange = {setPasswordHandler} required />
                        <span className = "password__bar"></span>
                        <label className="password__label">New Password (8 characters min)</label>
                        <div className = "setpassword__word">{passwordValidation}</div>
                    </div>

                    <div className = "password__group">      
                        <input className = "password__input" type = "password" value = {confirmPassword} onChange = {setConfirmPasswordHandler} required />
                        <span className = "password__bar"></span>
                        <label className="password__label">New Password (8 characters min)</label>
                        <div className = "setpassword__word">{confirmPasswordValidation}</div>
                    </div>
                </form>
            </div>
        </div>
    ...
    return (
        <div>
            <div className="zl_login_heading_text">
                <h3 className="zl_login_heading">Input the Secret Phrase</h3>
                <p className="zl_login_peregraph">
                    Input the secret phrase you append in each slot.
                </p>
            </div>
